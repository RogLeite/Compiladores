...
then
  ...
  gcc -Wall -I$SRCPATH -D$1 $SRCPATH/lexic_tester.c $TEMPFILE/tmp_lexic.c $TEMPFILE/tmp_grammatic.c $SRCPATH/ast.c $SRCPATH/var_table.c -o $SRCPATH/lexic_tester -lfl
